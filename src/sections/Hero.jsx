...
const Hero = () => {
  ...
  return (
    <section
      id="home
  "
      className="max-container flex min-h-screen w-full flex-col items-center justify-center gap-10 xl:flex-row"
    >
      ...
      <div className="contan relative flex flex-1 items-center justify-center bg-primary bg-hero bg-cover bg-center max-xl:py-40 xl:min-h-screen">
        <img
          src={bigShoeImg}
